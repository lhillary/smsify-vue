<template>
	...
	<ScrollPanel style="width: 100%; height: 78vh">
		<div class="text-900 font-medium text-xl mb-3">Results</div>
		<p class="m-0 mb-4 p-0 text-600 line-height-3 mr-3">This is a visualization of responses to your campaign after being analyzed by GPT-4 and sorted according to your campaign categories.</p>
